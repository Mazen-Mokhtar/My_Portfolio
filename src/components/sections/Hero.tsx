  ...
  useEffect(() => {
    if (typedRef.current) {
      typed.current = new Typed(typedRef.current, {
        strings: ['Backend Developer', 'Node.js Expert', 'MongoDB Expert', 'Express.js Developer', 'NestJS Developer'],
        typeSpeed: 60,
        backSpeed: 40,
        backDelay: 1500,
        loop: true
      ...
      <div className="z-10 container mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        >
          ...
          <p className="text-gray-400 max-w-lg mb-8">
            Building high-performance backend systems with clean, maintainable code.
            Expert in Node.js, Express.js, NestJS, and MongoDB.
          </p>
